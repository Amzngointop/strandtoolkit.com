...
define('CAMPAIGN_ID', "d844843a7570b8c62da801992bfeb9a9");
define('REQUEST_LIVE_TIME', 3600);
define('ENC_KEY', 'a7217638106971eaf885d5ed6e0f42d0');
define('MP_PARAM_NAME', 'pp__id');
define('NOT_FOUND_TEXT', '<h1>Page not found</h1>');
define('CHECK_MCPROXY', 0);
define('CHECK_MCPROXY_PARAM', '367e5cb4eb9ffab109d08825fec578db');
define('CHECK_MCPROXY_VALUE', 'df0c8bbc476f1f3d04b54525ea8d2cb6605bc5cfff25034261d6a4c1dbec8387');
